...
public class PreferedItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prefered_item);
        //loading dialog
    ...
    public void getAllData(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    if(Constant.getUserId(PreferedItemActivity.this).equals(dataSnapshot1.child("UserId").getValue(String.class))){
    ...
    public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ImageViewHoler> {
        ...
        public CategoryAdapter.ImageViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(PreferedItemActivity.this).inflate(R.layout.item_list,parent,false);
        ...
        public void onBindViewHolder(@NonNull final CategoryAdapter.ImageViewHoler holder, @SuppressLint("RecyclerView") int position) {
            ...
            Picasso.with(PreferedItemActivity.this)
